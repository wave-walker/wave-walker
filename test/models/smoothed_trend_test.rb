...
class SmoothedTrendTest < ActiveSupport::TestCase
  ...
  test '.bulk_create_for_duration correctly calculates bullish trend' do
    asset_pair = asset_pairs(:atomusd)
    duration = 1.day
    ...
    # Create SMMAs where fast (16) > slow (28) = bullish
    # and neutral conditions don't apply
    create_smma_set(
      asset_pair:,
      iso8601_duration:,
      range_position: 1000,
    ...
    trend = SmoothedTrend.find_by(asset_pair:, iso8601_duration:, range_position: 1000)
    assert_equal 'bullish', trend.trend
    assert_equal 100.0, trend.fast_smma
    assert_equal 94.0, trend.slow_smma
  end

  test '.bulk_create_for_duration correctly calculates bearish trend' do
    asset_pair = asset_pairs(:atomusd)
    duration = 1.day
    iso8601_duration = duration.iso8601
    ...
    # Create SMMAs where fast (16) < slow (28) = bearish
    # and neutral conditions don't apply
    create_smma_set(
      asset_pair:,
      iso8601_duration:,
    ...
    trend = SmoothedTrend.find_by(asset_pair:, iso8601_duration:, range_position: 1000)
    assert_equal 'bearish', trend.trend
    assert_equal 90.0, trend.fast_smma
    assert_equal 96.0, trend.slow_smma
  end

  test '.bulk_create_for_duration correctly calculates neutral trend when neutral_up condition is met' do
    asset_pair = asset_pairs(:atomusd)
    duration = 1.day
    iso8601_duration = duration.iso8601
    ...
    create_smma_set(
      ...
      iso8601_duration:,
      range_position: 1000,
      values: { 16 => 100.0, 19 => 102.0, 25 => 96.0, 28 => 94.0 }
    )

    SmoothedTrend.bulk_create_for_duration(asset_pair:, duration:)

    trend = SmoothedTrend.find_by(asset_pair:, iso8601_duration:, range_position: 1000)
    assert_equal 'neutral', trend.trend
  end

  test '.bulk_create_for_duration correctly calculates neutral trend when neutral_down condition is met' do
    asset_pair = asset_pairs(:atomusd)
    duration = 1.day
    iso8601_duration = duration.iso8601
    ...
    create_smma_set(
      ...
      iso8601_duration:,
      range_position: 1000,
      values: { 16 => 100.0, 19 => 98.0, 25 => 92.0, 28 => 94.0 }
    )
